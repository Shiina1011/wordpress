...
$xmagazine_menu_position = get_theme_mod('menu_position','center');
$slider_text = get_theme_mod('slider_text');
$x_magazine_header_search = get_theme_mod('xblog_header_search');
?>
<!doctype html>
...
<div id="page" class="site x-blog">
	...
	<header id="masthead" class="site-header baby-head-img">
		...
		<div class="menu-bar">
			<nav id="site-navigation" class="main-navigation text-<?php echo esc_attr($xmagazine_menu_position); ?>">
				<?php
					wp_nav_menu( array(
