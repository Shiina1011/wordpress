...
X magazine WordPress Theme, Copyright 2023 Noor alam
...
* Screenshot image two: CC0 by free photos via pxhere (https://pxhere.com/en/photo/758989 ) 
* Screenshot image three: CC0 by free photos via pxhere (https://pxhere.com/en/photo/192696 ) 
...
= 1.0.13 ==
* Added new style
* exerpt length changed

= 1.0.12 ==
* Empty image issue fixed
* List text width issue fixed

= 1.0.11 ==
* Added new style 
* Reduced feature image size 
